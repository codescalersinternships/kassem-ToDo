...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			span0 = element("span");
    			span0.textContent = "To-Do List";
    			t1 = space();
    			span1 = element("span");
    			t2 = text(/*completedItemCount*/ ctx[0]);
    			t3 = text("/");
    			t4 = text(/*itemCount*/ ctx[1]);
    			add_location(span0, file$4, 20, 5, 467);
    			add_location(span1, file$4, 21, 5, 496);
    			attr_dev(div, "class", "header svelte-145qw9d");
    			add_location(div, file$4, 19, 0, 441);
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*$items*/ 4) {
    			$$invalidate(0, completedItemCount = $items.filter(item => item.done).length);
    		}
    	};
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text("x");
    			attr_dev(input0, "class", "completed-checkbox svelte-1atpom8");
    			attr_dev(input0, "type", "checkbox");
    			add_location(input0, file$3, 58, 5, 1128);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "class", "text-input svelte-1atpom8");
    			input1.readOnly = /*done*/ ctx[1];
    			add_location(input1, file$3, 63, 5, 1263);
    			attr_dev(button, "class", "btn btn-danger delete svelte-1atpom8");
    			attr_dev(button, "id", /*ID*/ ctx[2]);
    			add_location(button, file$3, 71, 5, 1506);
    			attr_dev(div, "class", div_class_value = "" + (null_to_empty(/*done*/ ctx[1] == true ? " item done" : "item") + " svelte-1atpom8"));
    			add_location(div, file$3, 54, 0, 1064);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			input0.checked = /*done*/ ctx[1];
    			append_dev(div, t0);
    			append_dev(div, input1);
    			set_input_value(input1, /*task*/ ctx[0]);
    			append_dev(div, t1);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input1, "keyup", keyup_handler, false, false, false),
    					listen_dev(input1, "blur", /*blur_handler*/ ctx[8], false, false, false),
    					listen_dev(button, "click", /*handlebtnClick*/ ctx[4], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*done*/ 2) {
    				prop_dev(input1, "readOnly", /*done*/ ctx[1]);
    			}

    			if (dirty & /*task*/ 1 && input1.value !== /*task*/ ctx[0]) {
    				set_input_value(input1, /*task*/ ctx[0]);
    			}
    			...
    			if (dirty & /*done*/ 2 && div_class_value !== (div_class_value = "" + (null_to_empty(/*done*/ ctx[1] == true ? " item done" : "item") + " svelte-1atpom8"))) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function handlebtnClick(event) {
    		TodoApi.deleteTodo(event.target.id).then(async () => set_store_value(items, $items = await TodoApi.getAll(), $items));
    	}
    ...
    class Item extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { ID: 2, task: 0, done: 1 });
    		...
    		if (/*task*/ ctx[0] === undefined && !('task' in props)) {
    			console_1$1.warn("<Item> was created without expected prop 'task'");
    		}

    		if (/*done*/ ctx[1] === undefined && !('done' in props)) {
    			console_1$1.warn("<Item> was created without expected prop 'done'");
    		}
    	}
    ...
    /* src/components/newItem.svelte generated by Svelte v3.49.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-mabsl1");
    			add_location(input, file$2, 30, 0, 588);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(input, "keyup", /*handlerKeyUp*/ ctx[1], false, false, false),
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [value, handlerKeyUp, input_input_handler];
    }
    ...
    /* src/components/list.svelte generated by Svelte v3.49.0 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "list-status svelte-q4nklh");
    			add_location(p, file$1, 44, 10, 1182);
    		},
    		m: function mount(target, anchor) {
    ...
    // (40:5) {#each $items as item ,i (item)}
    function create_each_block(key_1, ctx) {
    	let first;
    	let item;
    	let current;
    	const item_spread_levels = [/*item*/ ctx[4], { clsss: "hhh" }];
    	let item_props = {};
    	...
    	item.$on("update", /*handleUpdateItem*/ ctx[2]);
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			? get_spread_update(item_spread_levels, [get_spread_object(/*item*/ ctx[4]), item_spread_levels[1]])
    			: {};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(40:5) {#each $items as item ,i (item)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "list svelte-q4nklh");
    			add_location(div, file$1, 36, 0, 974);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$items, handleUpdateItem*/ 5) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function handleNewItem(event) {
    		TodoApi.newTodo(event.detail).then(async () => set_store_value(items, $items = await TodoApi.getAll(), $items));
    	}

    	function handleUpdateItem(event) {
    		console.log("update with", event.detail.ID, event.detail.task, event.detail.done);
    		TodoApi.updateTodo(event.detail.ID, event.detail.task, event.detail.done).then(async () => set_store_value(items, $items = await TodoApi.getAll(), $items));
    	}
    	...
    	return [$items, handleNewItem, handleUpdateItem];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "container svelte-1j0ftbz");
    			add_location(div, file, 15, 0, 256);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
